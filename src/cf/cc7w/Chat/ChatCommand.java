...
public class ChatCommand implements CommandExecutor{
	...
	public boolean onCommand
		...
		if(label.equalsIgnoreCase("chatc")){
			...
			if(args.length == 0){
				sender.sendMessage("§e§l┌───────────────── §8§l<§a§lChatC§8§l>§r §8§l<§b§lV0.3§8§l>§r §e§l──────────────────");
				sender.sendMessage("§e§l├ §9您正在使用 §a§lChatC §9插件  ");
				sender.sendMessage("§e§l├ §9当前运行版本 §b§lV0.3");
			...
			if(args[0].equalsIgnoreCase("user")){
				...
				if(!(subcmd.equalsIgnoreCase("info") || subcmd.equalsIgnoreCase("reset") || subcmd.equalsIgnoreCase("prefix") || subcmd.equalsIgnoreCase("suffix") || subcmd.equalsIgnoreCase("format"))){
